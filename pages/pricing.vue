          ...
          >
            ...
            <ul class="feature-list">
              <li
                ...
                :key="idx"
                :class="{
                  'feature-list__item': true,
                  'feature-list__item--blue': index % 2 !== 0,
                }"
              >
                {{ feature }}
              </li>
...
export default {
  async asyncData({ params }) {
    const pageData = await import('~/content/_pricing.json');
    return pageData;
  },
  data() {
    return {};
